    ...
    return (
        <>
            <div className='container' style={myStyle}>
                <h2>About us </h2>
                <div className="accordion accordion-flush my-3" id="accordionFlushExample" style={myStyle}>
            ...
            <div className="container d-flex justify-content-center">
                ...
                <button className="btn btn-secondary my-5" onClick={enableDark}>{btnText}</button>
            </div>
        </>
    )
}
